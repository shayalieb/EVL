    ...
    articles: [
      ...
      },
      {
        ...
        blocks: [
          ...
          { type: 'tip', text: 'For a sound engineer or larger production, switch Advanced audio on. Each channel can then specify its input type, preferred mic or DI, acceptable substitute, stand and connector, mono/stereo format, stagebox patch, monitor mix, equipment provider, power, and cable needs. These optional details are included in emails, PDFs, and saved library templates; leave the switch off for a clean everyday view.' },
          { type: 'p', text: 'The Production readiness card checks the canvas and lists before you share. Resolve items identify problems such as an empty plot, a stale icon link, or two channels assigned to the same stagebox input. Suggested items improve clarity but never prevent you from sending or downloading the plot. Open Review details and choose an item to jump toward the Production List.' },
          ...
          { type: 'tip', text: "Use Send Rider to create one technical production package for your sound engineer or venue. It includes event and production contacts, the schedule, stage plot, Production List, audio details, and Backline List in the email and attached PDF. Uncheck any section the recipient does not need. Selection outlines and editing handles are automatically removed from sent images and PDFs." },
          { type: 'p', text: 'Use Share to create a secure read-only link for a venue or engineer. Choose an expiration or no expiration, copy the link, and review its view count and last-opened time later. Revoke it at any time, or create a replacement that immediately disables the old address. The public viewer is designed for phones and tablets and never shows editing controls.' },
          { type: 'p', text: 'Shared links use published revisions. Your edits continue autosaving privately; recipients keep seeing the last published version until you open Share and choose Publish Update. Add an optional change note, review who published each revision and when, or restore an older revision as a private draft. Restoring never changes the public version until you publish again.' },
