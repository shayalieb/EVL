...
function GroupEditor({ form, editing, busy, processingLogo, update, updateStationery, changeLogo, save, reset }) {
  ...
  return <form onSubmit={save} className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm sm:p-6">
    ...
    <div className="mt-5 grid gap-5 xl:grid-cols-2">
      ...
      <div className="xl:col-span-2"><Section title="Document preview" description="See how this group’s saved branding will appear before sending a document."><button type="button" onClick={() => setPreviewOpen(true)} data-testid="agency-group-preview-open-button" className="rounded-lg border border-indigo-200 bg-white px-4 py-2 text-sm font-semibold text-indigo-700 hover:bg-indigo-50">Preview documents</button></Section></div>
    </div>
