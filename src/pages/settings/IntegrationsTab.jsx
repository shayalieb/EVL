...
import { beginQuickBooksConnection, checkQuickBooksConnection, createQuickBooksCustomer, createQuickBooksVendor, disconnectQuickBooks, findQuickBooksCustomerMatches, findQuickBooksVendorMatches, getQuickBooksBillPreview, getQuickBooksPaymentPreview, getQuickBooksSetup, getQuickBooksStatus, getQuickBooksSyncPreview, getQuickBooksVendorPreview, linkQuickBooksCustomer, linkQuickBooksVendor, manuallyReconcileQuickBooksPayment, reconcileQuickBooksPayment, refreshQuickBooksReferenceData, saveQuickBooksMappings, syncQuickBooksBill, syncQuickBooksInvoice, syncQuickBooksPayment } from '../../lib/quickBooks';
...
export default function IntegrationsTab() {
  ...
  return <div className="max-w-3xl space-y-5">
    ...
    <section className="rounded-xl border border-slate-200 bg-slate-50 p-5"><h3 className="font-bold text-slate-800">Integration progress</h3><div className="mt-3 grid gap-3 text-sm text-slate-600 sm:grid-cols-2"><p>✓ Clients and QuickBooks customers</p><p>✓ Invoices and client payments</p><p>✓ Contractors and vendors</p><p>✓ Contractor bills</p></div><p className="mt-4 text-xs text-slate-500">Next: reconcile contractor payments with their QuickBooks bills. Nothing is sent automatically.</p></section>
  </div>;
}
