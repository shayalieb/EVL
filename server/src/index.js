...
import designPartnerAgreementsRouter from './routes/designPartnerAgreements.js';
import remindersRouter from './routes/reminders.js';
import emailDomainsRouter from './routes/emailDomains.js';
import stagePlotsRouter, { publicStagePlotsRouter } from './routes/stagePlots.js';
import runOfShowRouter, { publicRunOfShowRouter } from './routes/runOfShow.js';
import runOfShowLibraryRouter from './routes/runOfShowLibrary.js';
import stagePlotLibraryRouter from './routes/stagePlotLibrary.js';
...
import contractorGroupsRouter from './routes/contractorGroups.js';
...
app.use('/api/public/stage-plots', publicStagePlotsRouter);
app.use('/api/stage-plot-library', stagePlotLibraryRouter);
app.use('/api/run-of-show', runOfShowRouter);
app.use('/api/public/run-of-show', publicRunOfShowRouter);
app.use('/api/run-of-show-library', runOfShowLibraryRouter);
...
app.use('/api/contractor-groups', contractorGroupsRouter);
